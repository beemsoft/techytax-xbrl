 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildAmount1stQuarter" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildAmount2ndQuarter" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildAmount3rdQuarter" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildAmount4thQuarter" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildDateOfBirth" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildInitials" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildReasonNoChildBenefitStudentGrant" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}MaintenanceChildYearTotal" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "MaintenanceChildAmount1stQuarter", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType maintenanceChildAmount1StQuarter;
    @XmlElement(name = "MaintenanceChildAmount2ndQuarter", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType maintenanceChildAmount2NdQuarter;
    @XmlElement(name = "MaintenanceChildAmount3rdQuarter", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType maintenanceChildAmount3RdQuarter;
    @XmlElement(name = "MaintenanceChildAmount4thQuarter", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType maintenanceChildAmount4ThQuarter;
    @XmlElement(name = "MaintenanceChildDateOfBirth", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected DateItemType maintenanceChildDateOfBirth;
    @XmlElement(name = "MaintenanceChildInitials", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected Anstring10VItemType maintenanceChildInitials;
    @XmlElement(name = "MaintenanceChildReasonNoChildBenefitStudentGrant", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected Anstring70VItemType maintenanceChildReasonNoChildBenefitStudentGrant;
    @XmlElement(name = "MaintenanceChildYearTotal", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
