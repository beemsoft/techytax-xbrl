 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereReducedRateNonOptingTaxpayerCountry" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereReducedRateNonOptingTaxpayerIncomeAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereReducedRateNonOptingTaxpayerIncomeDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereReducedRateNonOptingTaxpayerPercentage" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "TaxationElsewhereReducedRateNonOptingTaxpayerCountry", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected IsoCountryCodes3CharactersItemType taxationElsewhereReducedRateNonOptingTaxpayerCountry;
    @XmlElement(name = "TaxationElsewhereReducedRateNonOptingTaxpayerIncomeAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType taxationElsewhereReducedRateNonOptingTaxpayerIncomeAmount;
    @XmlElement(name = "TaxationElsewhereReducedRateNonOptingTaxpayerIncomeDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring35VItemType taxationElsewhereReducedRateNonOptingTaxpayerIncomeDescription;
    @XmlElement(name = "TaxationElsewhereReducedRateNonOptingTaxpayerPercentage", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
