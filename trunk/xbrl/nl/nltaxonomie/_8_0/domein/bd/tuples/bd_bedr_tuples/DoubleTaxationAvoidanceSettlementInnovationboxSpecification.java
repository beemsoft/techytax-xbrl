 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSettlementInnovationboxCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSettlementInnovationboxDeductibleTax" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSettlementInnovationboxForwardShiftingPreviousYears" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSettlementInnovationboxGrossRoyalties" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSettlementInnovationboxRoyaltiesDeductibleCosts" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxCountryCode", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected IsoCountryCodes3CharactersItemType doubleTaxationAvoidanceSettlementInnovationboxCountryCode;
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxDeductibleTax", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected NonNegativeMonetaryNoDecimalsItemType doubleTaxationAvoidanceSettlementInnovationboxDeductibleTax;
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxForwardShiftingPreviousYears", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    ...
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxGrossRoyalties", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected NonNegativeMonetaryNoDecimalsItemType doubleTaxationAvoidanceSettlementInnovationboxGrossRoyalties;
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxRoyaltiesDeductibleCosts", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
