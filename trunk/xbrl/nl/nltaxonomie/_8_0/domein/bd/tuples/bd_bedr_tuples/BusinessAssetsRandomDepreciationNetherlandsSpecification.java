 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetsRandomDepreciationNetherlandsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetsRandomDepreciationNetherlandsBookValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetsRandomDepreciationNetherlandsDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetsRandomDepreciationNetherlandsTemporary" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "BusinessAssetsRandomDepreciationNetherlandsAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType businessAssetsRandomDepreciationNetherlandsAmount;
    @XmlElement(name = "BusinessAssetsRandomDepreciationNetherlandsBookValue", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType businessAssetsRandomDepreciationNetherlandsBookValue;
    @XmlElement(name = "BusinessAssetsRandomDepreciationNetherlandsDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring45VItemType businessAssetsRandomDepreciationNetherlandsDescription;
    @XmlElement(name = "BusinessAssetsRandomDepreciationNetherlandsTemporary", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
