 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}ForeignBenefitsAgencyNameAndAddress" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}IncomePreviousWorkAbroadWithoutDutchWageTaxAmount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ForeignBenefitsAgencyNameAndAddress", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring70VItemType foreignBenefitsAgencyNameAndAddress;
    @XmlElement(name = "IncomePreviousWorkAbroadWithoutDutchWageTaxAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
