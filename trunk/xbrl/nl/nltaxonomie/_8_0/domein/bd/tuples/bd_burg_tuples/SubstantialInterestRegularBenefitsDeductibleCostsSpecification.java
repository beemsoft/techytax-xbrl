 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}SubstantialInterestRegularBenefitsDeductibleCostsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}SubstantialInterestRegularBenefitsDeductibleCostsDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "SubstantialInterestRegularBenefitsDeductibleCostsAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType substantialInterestRegularBenefitsDeductibleCostsAmount;
    @XmlElement(name = "SubstantialInterestRegularBenefitsDeductibleCostsDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
