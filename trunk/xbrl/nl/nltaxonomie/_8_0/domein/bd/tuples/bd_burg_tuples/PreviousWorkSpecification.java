 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}PreviousWorkBenefitsAgencyName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}PreviousWorkIncomeAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}PreviousWorkWithheldWageLevy" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PreviousWorkBenefitsAgencyName", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring70VItemType previousWorkBenefitsAgencyName;
    @XmlElement(name = "PreviousWorkIncomeAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType previousWorkIncomeAmount;
    @XmlElement(name = "PreviousWorkWithheldWageLevy", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
