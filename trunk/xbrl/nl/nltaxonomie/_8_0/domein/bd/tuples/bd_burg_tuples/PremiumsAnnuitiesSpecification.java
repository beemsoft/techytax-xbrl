 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}PremiumsAnnuitiesInsurerName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}PremiumsAnnuitiesPaidAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}PremiumsAnnuitiesPolicyNumber" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PremiumsAnnuitiesInsurerName", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring60VItemType premiumsAnnuitiesInsurerName;
    @XmlElement(name = "PremiumsAnnuitiesPaidAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType premiumsAnnuitiesPaidAmount;
    @XmlElement(name = "PremiumsAnnuitiesPolicyNumber", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
