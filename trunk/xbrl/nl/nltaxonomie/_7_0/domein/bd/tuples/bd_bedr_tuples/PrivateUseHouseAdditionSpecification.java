 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateUseHouseAdditionAddress" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateUseHouseAdditionImmovablePropertyLawValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateUseHouseAdditionOwnHouseValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateUseHouseAdditionPeriodEnd" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateUseHouseAdditionPeriodStart" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateUseHouseAdditionRightsPercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateUseHouseAdditionWithdrawal" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PrivateUseHouseAdditionAddress", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected Anstring60VItemType privateUseHouseAdditionAddress;
    @XmlElement(name = "PrivateUseHouseAdditionImmovablePropertyLawValue", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType privateUseHouseAdditionImmovablePropertyLawValue;
    @XmlElement(name = "PrivateUseHouseAdditionOwnHouseValue", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected NonNegativeMonetaryNoDecimalsItemType privateUseHouseAdditionOwnHouseValue;
    @XmlElement(name = "PrivateUseHouseAdditionPeriodEnd", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected DateItemType privateUseHouseAdditionPeriodEnd;
    @XmlElement(name = "PrivateUseHouseAdditionPeriodStart", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected DateItemType privateUseHouseAdditionPeriodStart;
    @XmlElement(name = "PrivateUseHouseAdditionRightsPercentage", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected Pure52ItemType privateUseHouseAdditionRightsPercentage;
    @XmlElement(name = "PrivateUseHouseAdditionWithdrawal", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
