...
public class EditBtwMatchPrivateAction extends Action {
	private static final Log log = LogFactory.getLog(EditBtwMatchPrivateAction.class);
		...
		if (StringUtils.isNotEmpty(id)) {
			try {
				...
				if (kostmatch.getVatType() == null) {
					...
					VatMatch btwmatch = btwmatchDao.getVatMatchPrivate(id);
					if (btwmatch == null) {
						btwmatchDao.insertVatMatchPrivate(kostmatch);
					}
				}
