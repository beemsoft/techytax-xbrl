...
public class UpdateKostensoortAction extends Action {
	
	private static final Log log = LogFactory.getLog(UpdateKostensoortAction.class);
	...
	public ActionForward execute(
		...
		log.debug("Update de kostensoort gegevens.");
		...
		kostensoortDao.updateKostensoort(kostensoort);
