 ...
 */
public class GetBerichtenLijstRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument
{
    
    public GetBerichtenLijstRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETBERICHTENLIJSTREQUEST$0 = 
        new javax.xml.namespace.QName("http://logius.nl/digipoort/koppelvlakservices/1.2/", "getBerichtenLijstRequest");
    
    
    /**
     * Gets the "getBerichtenLijstRequest" element
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument.GetBerichtenLijstRequest getGetBerichtenLijstRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument.GetBerichtenLijstRequest target = null;
            target = (nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument.GetBerichtenLijstRequest)get_store().find_element_user(GETBERICHTENLIJSTREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetBerichtenLijstRequest(nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument.GetBerichtenLijstRequest getBerichtenLijstRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument.GetBerichtenLijstRequest)get_store().add_element_user(GETBERICHTENLIJSTREQUEST$0);
            }
            target.set(getBerichtenLijstRequest);
        }
    }
     ...
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument.GetBerichtenLijstRequest addNewGetBerichtenLijstRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetBerichtenLijstRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetBerichtenLijstRequestDocument.GetBerichtenLijstRequest
    {
        
        public GetBerichtenLijstRequestImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
