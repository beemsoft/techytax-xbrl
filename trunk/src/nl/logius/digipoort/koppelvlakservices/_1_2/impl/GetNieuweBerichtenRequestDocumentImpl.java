 ...
 */
public class GetNieuweBerichtenRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument
{
    
    public GetNieuweBerichtenRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETNIEUWEBERICHTENREQUEST$0 = 
        new javax.xml.namespace.QName("http://logius.nl/digipoort/koppelvlakservices/1.2/", "getNieuweBerichtenRequest");
    
    
    /**
     * Gets the "getNieuweBerichtenRequest" element
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument.GetNieuweBerichtenRequest getGetNieuweBerichtenRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument.GetNieuweBerichtenRequest target = null;
            target = (nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument.GetNieuweBerichtenRequest)get_store().find_element_user(GETNIEUWEBERICHTENREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetNieuweBerichtenRequest(nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument.GetNieuweBerichtenRequest getNieuweBerichtenRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument.GetNieuweBerichtenRequest)get_store().add_element_user(GETNIEUWEBERICHTENREQUEST$0);
            }
            target.set(getNieuweBerichtenRequest);
        }
    }
     ...
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument.GetNieuweBerichtenRequest addNewGetNieuweBerichtenRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetNieuweBerichtenRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenRequestDocument.GetNieuweBerichtenRequest
    {
        
        public GetNieuweBerichtenRequestImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
