 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}RefundPremiumsAndOtherNegativeIncomeProvisionExpensesAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}RefundPremiumsAndOtherNegativeIncomeProvisionExpensesDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "RefundPremiumsAndOtherNegativeIncomeProvisionExpensesAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType refundPremiumsAndOtherNegativeIncomeProvisionExpensesAmount;
    @XmlElement(name = "RefundPremiumsAndOtherNegativeIncomeProvisionExpensesDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
