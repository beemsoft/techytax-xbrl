 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ExchangeRateExemptionMethod" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ExemptionMethodCountry" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ExemptionMethodForwardedProfitOrLossToOvertake" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ExemptionMethodProfitComponent" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ExemptionMethodProfitNationalCurrency" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ProfitEuroExemptionMethod" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ExchangeRateExemptionMethod", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring11VItemType exchangeRateExemptionMethod;
    @XmlElement(name = "ExemptionMethodCountry", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected IsoCountryCodes3CharactersItemType exemptionMethodCountry;
    @XmlElement(name = "ExemptionMethodForwardedProfitOrLossToOvertake", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType exemptionMethodForwardedProfitOrLossToOvertake;
    @XmlElement(name = "ExemptionMethodProfitComponent", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring45VItemType exemptionMethodProfitComponent;
    @XmlElement(name = "ExemptionMethodProfitNationalCurrency", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType exemptionMethodProfitNationalCurrency;
    @XmlElement(name = "ProfitEuroExemptionMethod", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
