 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}OwnHousePeriodicContributionsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}OwnHousePeriodicContributionsDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "OwnHousePeriodicContributionsAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType ownHousePeriodicContributionsAmount;
    @XmlElement(name = "OwnHousePeriodicContributionsDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
