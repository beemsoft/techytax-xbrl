 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentAllowancePerInvestmentAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentAllowanceThisFinancialYear" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentFinancialYearAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentInitialStartingDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentNotificationNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentPaidThisFinancialYear" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}BusinessAssetEnvironmentalEnergyInvestmentPercentage" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentAllowancePerInvestmentAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType businessAssetEnvironmentalEnergyInvestmentAllowancePerInvestmentAmount;
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentAllowanceThisFinancialYear", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected NonNegativeMonetaryNoDecimalsItemType businessAssetEnvironmentalEnergyInvestmentAllowanceThisFinancialYear;
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType businessAssetEnvironmentalEnergyInvestmentDescription;
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentFinancialYearAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType businessAssetEnvironmentalEnergyInvestmentFinancialYearAmount;
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentInitialStartingDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected DateItemType businessAssetEnvironmentalEnergyInvestmentInitialStartingDate;
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentNotificationNumber", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected NotificationNumberItemType businessAssetEnvironmentalEnergyInvestmentNotificationNumber;
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentPaidThisFinancialYear", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType businessAssetEnvironmentalEnergyInvestmentPaidThisFinancialYear;
    @XmlElement(name = "BusinessAssetEnvironmentalEnergyInvestmentPercentage", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
