 ...
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}PlotOfLandBookValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}WithdrawalDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}WithdrawingDueToTransferLandToPrivateAmount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PlotOfLandBookValue", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType plotOfLandBookValue;
    @XmlElement(name = "WithdrawalDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected DateItemType withdrawalDate;
    @XmlElement(name = "WithdrawingDueToTransferLandToPrivateAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
