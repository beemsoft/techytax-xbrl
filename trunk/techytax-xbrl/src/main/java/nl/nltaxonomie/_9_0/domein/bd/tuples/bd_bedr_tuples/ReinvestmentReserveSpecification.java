 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}ReinvestmentReserveDisposedBusinessAssetBookProfit" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}ReinvestmentReserveDisposedBusinessAssetBookValueAtTransferTime" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}ReinvestmentReserveDisposedBusinessAssetDepreciationPercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}ReinvestmentReserveDisposedBusinessAssetDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}ReinvestmentReserveDisposedBusinessAssetYear" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetBookProfit", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType reinvestmentReserveDisposedBusinessAssetBookProfit;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetBookValueAtTransferTime", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType reinvestmentReserveDisposedBusinessAssetBookValueAtTransferTime;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetDepreciationPercentage", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected Pure52ItemType reinvestmentReserveDisposedBusinessAssetDepreciationPercentage;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetDescription", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType reinvestmentReserveDisposedBusinessAssetDescription;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetYear", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
