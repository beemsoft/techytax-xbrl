 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}SettlementDateSubsidiariesTerminationFromTaxentityByDissolutionAndSettlementTitle" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}SettlementSubsidiaryUnpaidDebts" minOccurs="0"/>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "SettlementDateSubsidiariesTerminationFromTaxentityByDissolutionAndSettlementTitle", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected DateItemType settlementDateSubsidiariesTerminationFromTaxentityByDissolutionAndSettlementTitle;
    @XmlElement(name = "SettlementSubsidiaryUnpaidDebts", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
