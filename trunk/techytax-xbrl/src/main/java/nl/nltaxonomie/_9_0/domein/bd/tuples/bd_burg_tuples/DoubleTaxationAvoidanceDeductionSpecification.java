 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}DoubleTaxationAvoidanceDeductionInheritanceSimilarTaxPaidCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}DoubleTaxationAvoidanceDeductionInheritanceTaxSimilarPaidOtherCountry" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DoubleTaxationAvoidanceDeductionInheritanceSimilarTaxPaidCountryCode", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected IsoCountryCodes3CharactersItemType doubleTaxationAvoidanceDeductionInheritanceSimilarTaxPaidCountryCode;
    @XmlElement(name = "DoubleTaxationAvoidanceDeductionInheritanceTaxSimilarPaidOtherCountry", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
