 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}PreservedIncomePensionClaim" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}PreservedIncomePensionClaimFairValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}PreservedIncomePensionClaimInOwnManagement" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}PreservedIncomePensionClaimInsuranceCompanyName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}PreservedIncomePensionClaimPolicyNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}PreservedIncomePensionClaimPremiumsPaid" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PreservedIncomePensionClaim", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType preservedIncomePensionClaim;
    @XmlElement(name = "PreservedIncomePensionClaimFairValue", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected BooleanItemType preservedIncomePensionClaimFairValue;
    @XmlElement(name = "PreservedIncomePensionClaimInOwnManagement", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected BooleanItemType preservedIncomePensionClaimInOwnManagement;
    @XmlElement(name = "PreservedIncomePensionClaimInsuranceCompanyName", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Anstring70VItemType preservedIncomePensionClaimInsuranceCompanyName;
    @XmlElement(name = "PreservedIncomePensionClaimPolicyNumber", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Anstring20VItemType preservedIncomePensionClaimPolicyNumber;
    @XmlElement(name = "PreservedIncomePensionClaimPremiumsPaid", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
