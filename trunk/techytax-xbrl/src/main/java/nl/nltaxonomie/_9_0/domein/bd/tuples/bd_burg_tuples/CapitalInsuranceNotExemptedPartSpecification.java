 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}CapitalInsuranceNotExemptedPartCapitalInsurancePolicyNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}CapitalInsuranceNotExemptedPartCapitalInsuranceValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}CapitalInsuranceNotExemptedPartLifeInsuranceSocietyName" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CapitalInsuranceNotExemptedPartCapitalInsurancePolicyNumber", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Anstring34VItemType capitalInsuranceNotExemptedPartCapitalInsurancePolicyNumber;
    @XmlElement(name = "CapitalInsuranceNotExemptedPartCapitalInsuranceValue", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType capitalInsuranceNotExemptedPartCapitalInsuranceValue;
    @XmlElement(name = "CapitalInsuranceNotExemptedPartLifeInsuranceSocietyName", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
