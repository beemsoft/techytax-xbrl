 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}LandDisposalDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}LandRegistryDetailsArea" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}LandRegistryDetailsMunicipality" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}LandRegistryDetailsSectionNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}ParcelDisposedSalesPrice" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven}SectionSoldBookValue" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "LandDisposalDate", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected DateItemType landDisposalDate;
    @XmlElement(name = "LandRegistryDetailsArea", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType landRegistryDetailsArea;
    @XmlElement(name = "LandRegistryDetailsMunicipality", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType landRegistryDetailsMunicipality;
    @XmlElement(name = "LandRegistryDetailsSectionNumber", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType landRegistryDetailsSectionNumber;
    @XmlElement(name = "ParcelDisposedSalesPrice", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType parcelDisposedSalesPrice;
    @XmlElement(name = "SectionSoldBookValue", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-bedrijven")
