 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}SharesSubstantialInterestAndSuchDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}SharesSubstantialInterestCount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "SharesSubstantialInterestAndSuchDescription", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Anstring60VItemType sharesSubstantialInterestAndSuchDescription;
    @XmlElement(name = "SharesSubstantialInterestCount", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
