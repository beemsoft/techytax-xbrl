 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}PeriodicPaymentDeductibleCostsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}PeriodicPaymentDeductibleCostsDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PeriodicPaymentDeductibleCostsAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType periodicPaymentDeductibleCostsAmount;
    @XmlElement(name = "PeriodicPaymentDeductibleCostsDescription", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
