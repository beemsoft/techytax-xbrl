 ...
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen}HouseNumberAbroad" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen}PlaceOfResidenceAbroad" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen}PostalCodeAbroad" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen}StreetNameAbroad" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AddressAbroadTitle
    extends Placeholder
{
    ...
    @XmlElement(name = "HouseNumberAbroad", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen")
    protected Anstring9VItemType houseNumberAbroad;
    @XmlElement(name = "PlaceOfResidenceAbroad", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen")
    protected Anstring24VItemType placeOfResidenceAbroad;
    @XmlElement(name = "PostalCodeAbroad", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen")
    protected Anstring9VItemType postalCodeAbroad;
    @XmlElement(name = "StreetNameAbroad", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-algemeen")
