 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}PremiumsSettlementOldAgeReserveDiscontinuationProfitAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}PremiumsSettlementOldAgeReserveDiscontinuationProfitDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PremiumsSettlementOldAgeReserveDiscontinuationProfitAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType premiumsSettlementOldAgeReserveDiscontinuationProfitAmount;
    @XmlElement(name = "PremiumsSettlementOldAgeReserveDiscontinuationProfitDescription", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
