 ...
 * generated in the nl.nltaxonomie._7_0.domein.bd.tuples.bd_asl_tuples package. 
...
public class ObjectFactory {
    ...
    private final static QName _NameAddressTaxconsultantSpecification_QNAME = new QName("http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", "NameAddressTaxconsultantSpecification");
    private final static QName _TaxData_QNAME = new QName("http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", "TaxData");
    private final static QName _IncomePreviousEmploymentSpecification_QNAME = new QName("http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", "IncomePreviousEmploymentSpecification");
    private final static QName _NameAddressTaxpayerSpecification_QNAME = new QName("http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", "NameAddressTaxpayerSpecification");
    private final static QName _NameAddressSenderSpecification_QNAME = new QName("http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", "NameAddressSenderSpecification");
    private final static QName _IncomePresentEmploymentSpecification_QNAME = new QName("http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", "IncomePresentEmploymentSpecification");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: nl.nltaxonomie._7_0.domein.bd.tuples.bd_asl_tuples
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", name = "NameAddressTaxconsultantSpecification", substitutionHeadNamespace = "http://www.nltaxonomie.nl/2011/xbrl/xbrl-syntax-extension", substitutionHeadName = "presentationTuple")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", name = "TaxData", substitutionHeadNamespace = "http://www.xbrl.org/2003/instance", substitutionHeadName = "tuple")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", name = "IncomePreviousEmploymentSpecification", substitutionHeadNamespace = "http://www.nltaxonomie.nl/2011/xbrl/xbrl-syntax-extension", substitutionHeadName = "specificationTuple")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", name = "NameAddressTaxpayerSpecification", substitutionHeadNamespace = "http://www.nltaxonomie.nl/2011/xbrl/xbrl-syntax-extension", substitutionHeadName = "presentationTuple")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", name = "NameAddressSenderSpecification", substitutionHeadNamespace = "http://www.nltaxonomie.nl/2011/xbrl/xbrl-syntax-extension", substitutionHeadName = "presentationTuple")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.nltaxonomie.nl/7.0/domein/bd/tuples/bd-asl-tuples", name = "IncomePresentEmploymentSpecification", substitutionHeadNamespace = "http://www.nltaxonomie.nl/2011/xbrl/xbrl-syntax-extension", substitutionHeadName = "specificationTuple")
