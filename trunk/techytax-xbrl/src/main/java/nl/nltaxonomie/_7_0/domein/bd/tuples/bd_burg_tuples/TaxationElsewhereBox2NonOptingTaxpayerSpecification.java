 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}TaxationElsewhereBox2NonOptingTaxpayerAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}TaxationElsewhereBox2NonOptingTaxpayerDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "TaxationElsewhereBox2NonOptingTaxpayerAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType taxationElsewhereBox2NonOptingTaxpayerAmount;
    @XmlElement(name = "TaxationElsewhereBox2NonOptingTaxpayerDescription", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
