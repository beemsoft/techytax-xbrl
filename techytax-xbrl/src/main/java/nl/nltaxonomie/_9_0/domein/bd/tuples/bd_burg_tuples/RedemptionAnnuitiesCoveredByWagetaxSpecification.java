 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}RedemptionAnnuitiesCoveredByWagetaxAnnuityRedemption" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}RedemptionAnnuitiesCoveredByWagetaxPayingAgencyName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}RedemptionAnnuitiesCoveredByWagetaxWageLevy" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "RedemptionAnnuitiesCoveredByWagetaxAnnuityRedemption", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType redemptionAnnuitiesCoveredByWagetaxAnnuityRedemption;
    @XmlElement(name = "RedemptionAnnuitiesCoveredByWagetaxPayingAgencyName", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Anstring35VItemType redemptionAnnuitiesCoveredByWagetaxPayingAgencyName;
    @XmlElement(name = "RedemptionAnnuitiesCoveredByWagetaxWageLevy", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
