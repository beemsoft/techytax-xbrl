 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}AssetsOnBankStockAccountsForeignAccountHolderIdentificationNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}AssetsOnBankStockAccountsForeignBankAccountNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}AssetsOnBankStockAccountsForeignBankName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}AssetsOnBankStockAccountsForeignCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}AssetsOnBankStockAccountsForeignInterestTypeCode" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "AssetsOnBankStockAccountsForeignAccountHolderIdentificationNumber", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Test11ItemType assetsOnBankStockAccountsForeignAccountHolderIdentificationNumber;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignBankAccountNumber", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Anstring34VItemType assetsOnBankStockAccountsForeignBankAccountNumber;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignBankName", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected Anstring70VItemType assetsOnBankStockAccountsForeignBankName;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignCountryCode", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected IsoCountryCodes3CharactersItemType assetsOnBankStockAccountsForeignCountryCode;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignInterestTypeCode", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
