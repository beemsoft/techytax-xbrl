 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}OwnHouseGroundLeaseBuildingPeriodicPaymentsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers}OwnHouseGroundLeaseBuildingPeriodicPaymentsDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "OwnHouseGroundLeaseBuildingPeriodicPaymentsAmount", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType ownHouseGroundLeaseBuildingPeriodicPaymentsAmount;
    @XmlElement(name = "OwnHouseGroundLeaseBuildingPeriodicPaymentsDescription", namespace = "http://www.nltaxonomie.nl/9.0/basis/bd/items/bd-burgers")
