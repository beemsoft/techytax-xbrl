 ...
 *         &lt;/choice>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}ImmovablePropertyContributionEstimationValuer" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}ImmovablePropertyContributionValueOfTrade" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}ImmovablePropertyContributionValuerName" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ImmovablePropertyContributionEstimationValuer", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected BooleanItemType immovablePropertyContributionEstimationValuer;
    @XmlElement(name = "ImmovablePropertyContributionValueOfTrade", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType immovablePropertyContributionValueOfTrade;
    @XmlElement(name = "ImmovablePropertyContributionValuerName", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
