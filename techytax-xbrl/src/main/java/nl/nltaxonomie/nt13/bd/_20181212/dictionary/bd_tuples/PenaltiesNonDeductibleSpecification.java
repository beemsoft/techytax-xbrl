 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}PenaltiesNonDeductibleDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}PenaltiesNonDeductibleTotal" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PenaltiesNonDeductibleDescription", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected Anstring70VItemType penaltiesNonDeductibleDescription;
    @XmlElement(name = "PenaltiesNonDeductibleTotal", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
