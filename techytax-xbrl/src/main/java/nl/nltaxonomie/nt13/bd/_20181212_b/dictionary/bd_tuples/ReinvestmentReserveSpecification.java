 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}ReinvestmentReserveDisposedBusinessAssetBookProfit" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}ReinvestmentReserveDisposedBusinessAssetBookValueAtTransferTime" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}ReinvestmentReserveDisposedBusinessAssetDepreciationPercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}ReinvestmentReserveDisposedBusinessAssetDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}ReinvestmentReserveDisposedBusinessAssetYear" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetBookProfit", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType reinvestmentReserveDisposedBusinessAssetBookProfit;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetBookValueAtTransferTime", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType reinvestmentReserveDisposedBusinessAssetBookValueAtTransferTime;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetDepreciationPercentage", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected Perc32ItemType reinvestmentReserveDisposedBusinessAssetDepreciationPercentage;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetDescription", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected Anstring70VItemType reinvestmentReserveDisposedBusinessAssetDescription;
    @XmlElement(name = "ReinvestmentReserveDisposedBusinessAssetYear", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
