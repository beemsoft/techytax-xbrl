 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CapitalInsuranceNotExemptedPartCapitalInsurancePolicyNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CapitalInsuranceNotExemptedPartCapitalInsuranceValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CapitalInsuranceNotExemptedPartLifeInsuranceSocietyName" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CapitalInsuranceNotExemptedPartCapitalInsurancePolicyNumber", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected Anstring34VItemType capitalInsuranceNotExemptedPartCapitalInsurancePolicyNumber;
    @XmlElement(name = "CapitalInsuranceNotExemptedPartCapitalInsuranceValue", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType capitalInsuranceNotExemptedPartCapitalInsuranceValue;
    @XmlElement(name = "CapitalInsuranceNotExemptedPartLifeInsuranceSocietyName", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
