 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}DividendAccountHolderIdentificationNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}DividendBankAccountNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}DividendCommonInterestIndication" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}DividendLabel" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-tuples}DividendPerCountrySpecification" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}DividendProductID" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}DividendSourceBankTaxReferenceNumber" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DividendAccountHolderIdentificationNumber", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected Test11ItemType dividendAccountHolderIdentificationNumber;
    @XmlElement(name = "DividendBankAccountNumber", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected Anstring34VItemType dividendBankAccountNumber;
    @XmlElement(name = "DividendCommonInterestIndication", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected NonNegativeInteger2FItemType dividendCommonInterestIndication;
    @XmlElement(name = "DividendLabel", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected Anstring70VItemType dividendLabel;
    @XmlElement(name = "DividendPerCountrySpecification", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-tuples")
    protected List<DividendPerCountrySpecification> dividendPerCountrySpecification;
    @XmlElement(name = "DividendProductID", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected Anstring20VItemType dividendProductID;
    @XmlElement(name = "DividendSourceBankTaxReferenceNumber", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
