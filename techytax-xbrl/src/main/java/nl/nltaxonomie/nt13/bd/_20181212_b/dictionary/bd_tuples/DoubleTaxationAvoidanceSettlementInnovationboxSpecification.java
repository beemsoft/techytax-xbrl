 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DoubleTaxationAvoidanceSettlementInnovationboxCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DoubleTaxationAvoidanceSettlementInnovationboxDeductibleTax" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DoubleTaxationAvoidanceSettlementInnovationboxForwardShiftingPreviousYears" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DoubleTaxationAvoidanceSettlementInnovationboxGrossRoyalties" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DoubleTaxationAvoidanceSettlementInnovationboxRoyaltiesDeductibleCosts" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxCountryCode", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected IsoCountryCodes3CharactersItemType doubleTaxationAvoidanceSettlementInnovationboxCountryCode;
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxDeductibleTax", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType doubleTaxationAvoidanceSettlementInnovationboxDeductibleTax;
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxForwardShiftingPreviousYears", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    ...
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxGrossRoyalties", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType doubleTaxationAvoidanceSettlementInnovationboxGrossRoyalties;
    @XmlElement(name = "DoubleTaxationAvoidanceSettlementInnovationboxRoyaltiesDeductibleCosts", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
