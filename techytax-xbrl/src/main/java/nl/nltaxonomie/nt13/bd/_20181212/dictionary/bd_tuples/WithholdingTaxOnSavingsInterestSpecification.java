...
import nl.nltaxonomie.nt13.bd._20181212.dictionary.bd_codes.IsoCountryCodeESRRItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}WithholdingTaxOnSavingsInterestAmount"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}WithholdingTaxOnSavingsInterestBankAccountNumber"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}WithholdingTaxOnSavingsInterestCountryCode"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "WithholdingTaxOnSavingsInterestAmount", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data", required = true)
    protected NonNegativeMonetaryNoDecimalsItemType withholdingTaxOnSavingsInterestAmount;
    @XmlElement(name = "WithholdingTaxOnSavingsInterestBankAccountNumber", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data", required = true)
    protected Anstring34VItemType withholdingTaxOnSavingsInterestBankAccountNumber;
    @XmlElement(name = "WithholdingTaxOnSavingsInterestCountryCode", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data", required = true)
