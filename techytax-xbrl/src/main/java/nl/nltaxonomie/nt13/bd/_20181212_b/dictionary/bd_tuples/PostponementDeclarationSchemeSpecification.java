...
import nl.nltaxonomie.nt13.bd._20181212_b.dictionary.bd_types.Anstring30VItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DeclarationsDeliveryPeriodicCumulativeNumberOfItems" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DeclarationsDeliveryPeriodicCumulativePercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}DeclarationsDeliveryPeriodicName" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DeclarationsDeliveryPeriodicCumulativeNumberOfItems", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected NonNegativeInteger5VItemType declarationsDeliveryPeriodicCumulativeNumberOfItems;
    @XmlElement(name = "DeclarationsDeliveryPeriodicCumulativePercentage", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected Perc32ItemType declarationsDeliveryPeriodicCumulativePercentage;
    @XmlElement(name = "DeclarationsDeliveryPeriodicName", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
