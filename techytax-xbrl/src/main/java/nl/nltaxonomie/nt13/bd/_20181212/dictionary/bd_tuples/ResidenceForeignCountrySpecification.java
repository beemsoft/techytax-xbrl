 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}CountryResidenceEndDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}CountryResidenceStartDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data}ResidenceForeignCountryCountryCodeISO" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CountryResidenceEndDate", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected DateItemType countryResidenceEndDate;
    @XmlElement(name = "CountryResidenceStartDate", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
    protected DateItemType countryResidenceStartDate;
    @XmlElement(name = "ResidenceForeignCountryCountryCodeISO", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212/dictionary/bd-data")
