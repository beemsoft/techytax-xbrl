 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.a/dictionary/bd-data}DebtsInConnectionWithResultFromActivitiesAmount" maxOccurs="2" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.a/dictionary/bd-data}DebtsInConnectionWithResultFromActivitiesDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DebtsInConnectionWithResultFromActivitiesAmount", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.a/dictionary/bd-data")
    protected List<MonetaryNoDecimalsItemType> debtsInConnectionWithResultFromActivitiesAmount;
    @XmlElement(name = "DebtsInConnectionWithResultFromActivitiesDescription", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.a/dictionary/bd-data")
