 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}ForeignBenefitsAgencyNameAndAddress" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}IncomePreviousWorkAbroadWithoutDutchWageTaxAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}IncomePreviousWorkAbroadWithoutDutchWageTaxCountryCode" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ForeignBenefitsAgencyNameAndAddress", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected Anstring70VItemType foreignBenefitsAgencyNameAndAddress;
    @XmlElement(name = "IncomePreviousWorkAbroadWithoutDutchWageTaxAmount", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType incomePreviousWorkAbroadWithoutDutchWageTaxAmount;
    @XmlElement(name = "IncomePreviousWorkAbroadWithoutDutchWageTaxCountryCode", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
