...
import nl.nltaxonomie.nt13.bd._20181212_b.dictionary.bd_types.NonNegativeInteger1ItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CommutingExpensesDaysPerWeekCount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CommutingExpensesDistance" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CommutingExpensesLocationOfActivities" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CommutingExpensesTaxDeductionByPeriodAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CommutingExpensesTaxDeductionPeriodEnd" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CommutingExpensesTaxDeductionPeriodStart" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data}CountDaysCommutedMoreThanNinetyKilometresSingleTrip" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CommutingExpensesDaysPerWeekCount", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected NonNegativeInteger1ItemType commutingExpensesDaysPerWeekCount;
    @XmlElement(name = "CommutingExpensesDistance", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected NonNegativeInteger3VItemType commutingExpensesDistance;
    @XmlElement(name = "CommutingExpensesLocationOfActivities", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected Anstring35VItemType commutingExpensesLocationOfActivities;
    @XmlElement(name = "CommutingExpensesTaxDeductionByPeriodAmount", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType commutingExpensesTaxDeductionByPeriodAmount;
    @XmlElement(name = "CommutingExpensesTaxDeductionPeriodEnd", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected DateItemType commutingExpensesTaxDeductionPeriodEnd;
    @XmlElement(name = "CommutingExpensesTaxDeductionPeriodStart", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
    protected DateItemType commutingExpensesTaxDeductionPeriodStart;
    @XmlElement(name = "CountDaysCommutedMoreThanNinetyKilometresSingleTrip", namespace = "http://www.nltaxonomie.nl/nt13/bd/20181212.b/dictionary/bd-data")
