 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}WeekendExpensesAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}WeekendExpensesDaysCount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}WeekendExpensesDisabledPersonDateOfBirth" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}WeekendExpensesDisabledPersonInitials" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}WeekendExpensesKilometresTravelled" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "WeekendExpensesAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType weekendExpensesAmount;
    @XmlElement(name = "WeekendExpensesDaysCount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected NonNegativeInteger3VItemType weekendExpensesDaysCount;
    @XmlElement(name = "WeekendExpensesDisabledPersonDateOfBirth", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected DateItemType weekendExpensesDisabledPersonDateOfBirth;
    @XmlElement(name = "WeekendExpensesDisabledPersonInitials", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected Anstring10VItemType weekendExpensesDisabledPersonInitials;
    @XmlElement(name = "WeekendExpensesKilometresTravelled", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
