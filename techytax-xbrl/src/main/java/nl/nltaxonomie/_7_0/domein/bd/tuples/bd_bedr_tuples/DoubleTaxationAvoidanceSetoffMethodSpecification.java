 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodCarryForwardAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodCountry" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodDeductibleCosts" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodGrossDividend" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodGrossInterest" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodGrossRoyalties" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodNonRecoverableTaxAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}DoubleTaxationAvoidanceSetoffMethodOtherGrossAmounts" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodCarryForwardAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType doubleTaxationAvoidanceSetoffMethodCarryForwardAmount;
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodCountry", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected IsoCountryCodes3CharactersItemType doubleTaxationAvoidanceSetoffMethodCountry;
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodDeductibleCosts", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType doubleTaxationAvoidanceSetoffMethodDeductibleCosts;
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodGrossDividend", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType doubleTaxationAvoidanceSetoffMethodGrossDividend;
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodGrossInterest", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType doubleTaxationAvoidanceSetoffMethodGrossInterest;
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodGrossRoyalties", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType doubleTaxationAvoidanceSetoffMethodGrossRoyalties;
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodNonRecoverableTaxAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType doubleTaxationAvoidanceSetoffMethodNonRecoverableTaxAmount;
    @XmlElement(name = "DoubleTaxationAvoidanceSetoffMethodOtherGrossAmounts", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
