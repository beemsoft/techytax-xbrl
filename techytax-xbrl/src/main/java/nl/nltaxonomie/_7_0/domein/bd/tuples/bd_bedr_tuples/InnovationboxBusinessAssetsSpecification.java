 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}InnovationBoxBusinessAssetsDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}InnovationBoxBusinessAssetsProductionCosts" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "InnovationBoxBusinessAssetsDescription", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType innovationBoxBusinessAssetsDescription;
    @XmlElement(name = "InnovationBoxBusinessAssetsProductionCosts", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
