 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingDeductibleExpenses" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingEntitlementPercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingExpensesThreshold" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingImmovablePropertyLawValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingJanuaryFirstCommercialValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingMaintenanceCostsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingMaintenanceCostsAmountCommitmentBefore2012" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingOwnHouseExists" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers}ListedBuildingSubsidy" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ListedBuildingDeductibleExpenses", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType listedBuildingDeductibleExpenses;
    @XmlElement(name = "ListedBuildingEntitlementPercentage", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected Pure30ItemType listedBuildingEntitlementPercentage;
    @XmlElement(name = "ListedBuildingExpensesThreshold", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType listedBuildingExpensesThreshold;
    @XmlElement(name = "ListedBuildingImmovablePropertyLawValue", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType listedBuildingImmovablePropertyLawValue;
    @XmlElement(name = "ListedBuildingJanuaryFirstCommercialValue", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType listedBuildingJanuaryFirstCommercialValue;
    @XmlElement(name = "ListedBuildingMaintenanceCostsAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType listedBuildingMaintenanceCostsAmount;
    @XmlElement(name = "ListedBuildingMaintenanceCostsAmountCommitmentBefore2012", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType listedBuildingMaintenanceCostsAmountCommitmentBefore2012;
    @XmlElement(name = "ListedBuildingOwnHouseExists", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
    protected BooleanItemType listedBuildingOwnHouseExists;
    @XmlElement(name = "ListedBuildingSubsidy", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-burgers")
