 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}LoanFinalStudyYearPeriodEndDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}LoanFinalStudyYearPeriodForfaitAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}LoanFinalStudyYearPeriodStartDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}LoanFinalStudyYearPeriodTrainingType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "LoanFinalStudyYearPeriodEndDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected DateItemType loanFinalStudyYearPeriodEndDate;
    @XmlElement(name = "LoanFinalStudyYearPeriodForfaitAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType loanFinalStudyYearPeriodForfaitAmount;
    @XmlElement(name = "LoanFinalStudyYearPeriodStartDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected DateItemType loanFinalStudyYearPeriodStartDate;
    @XmlElement(name = "LoanFinalStudyYearPeriodTrainingType", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
