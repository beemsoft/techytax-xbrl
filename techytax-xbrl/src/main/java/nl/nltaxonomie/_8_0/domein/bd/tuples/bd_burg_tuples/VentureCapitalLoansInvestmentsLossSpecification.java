 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}CityTownEntrepreneurParticipatingInterestFunds" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}EntrepreneurParticipatingInterestFundsStreetHouseNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}NameEntrepreneurParticipatingInterestFunds" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}PostalCodeEntrepreneurParticipatingInterestFunds" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}VentureCapitalLoansInvestmentsLossAmount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CityTownEntrepreneurParticipatingInterestFunds", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring35VItemType cityTownEntrepreneurParticipatingInterestFunds;
    @XmlElement(name = "EntrepreneurParticipatingInterestFundsStreetHouseNumber", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring35VItemType entrepreneurParticipatingInterestFundsStreetHouseNumber;
    @XmlElement(name = "NameEntrepreneurParticipatingInterestFunds", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring70VItemType nameEntrepreneurParticipatingInterestFunds;
    @XmlElement(name = "PostalCodeEntrepreneurParticipatingInterestFunds", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring9VItemType postalCodeEntrepreneurParticipatingInterestFunds;
    @XmlElement(name = "VentureCapitalLoansInvestmentsLossAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
