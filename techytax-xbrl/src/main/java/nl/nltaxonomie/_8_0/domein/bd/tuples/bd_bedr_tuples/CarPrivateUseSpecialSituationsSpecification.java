 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUseSpecialSituationsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUseSpecialSituationsDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CarPrivateUseSpecialSituationsAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType carPrivateUseSpecialSituationsAmount;
    @XmlElement(name = "CarPrivateUseSpecialSituationsDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
