 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}BackwardLossesToBeSettledTaxEntityCompanyIdentificationNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}BackwardLossesToBeSettledTaxEntityLossToBeSettledPreviousFinancialYear" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "BackwardLossesToBeSettledTaxEntityCompanyIdentificationNumber", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data")
    protected Test11ItemType backwardLossesToBeSettledTaxEntityCompanyIdentificationNumber;
    @XmlElement(name = "BackwardLossesToBeSettledTaxEntityLossToBeSettledPreviousFinancialYear", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data")
