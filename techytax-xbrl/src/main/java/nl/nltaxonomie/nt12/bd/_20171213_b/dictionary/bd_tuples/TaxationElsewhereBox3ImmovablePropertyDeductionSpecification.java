 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox3ImmovablePropertyDeductionAssets" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox3ImmovablePropertyDeductionCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox3ImmovablePropertyDeductionDescripton" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox3ImmovablePropertyDeductionValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox3ReductionAssetImmovablePropertyDebt" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "TaxationElsewhereBox3ImmovablePropertyDeductionAssets", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType taxationElsewhereBox3ImmovablePropertyDeductionAssets;
    @XmlElement(name = "TaxationElsewhereBox3ImmovablePropertyDeductionCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected IsoCountryCodes3CharactersItemType taxationElsewhereBox3ImmovablePropertyDeductionCountryCode;
    @XmlElement(name = "TaxationElsewhereBox3ImmovablePropertyDeductionDescripton", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected Anstring70VItemType taxationElsewhereBox3ImmovablePropertyDeductionDescripton;
    @XmlElement(name = "TaxationElsewhereBox3ImmovablePropertyDeductionValue", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType taxationElsewhereBox3ImmovablePropertyDeductionValue;
    @XmlElement(name = "TaxationElsewhereBox3ReductionAssetImmovablePropertyDebt", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
