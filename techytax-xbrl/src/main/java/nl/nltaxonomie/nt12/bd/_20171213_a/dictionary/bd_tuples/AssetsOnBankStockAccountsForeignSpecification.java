 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}AssetsOnBankStockAccountsForeignAccountHolderIdentificationNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}AssetsOnBankStockAccountsForeignBankAccountNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}AssetsOnBankStockAccountsForeignBankName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}AssetsOnBankStockAccountsForeignCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}AssetsOnBankStockAccountsForeignInterestTypeCode" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "AssetsOnBankStockAccountsForeignAccountHolderIdentificationNumber", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected Test11ItemType assetsOnBankStockAccountsForeignAccountHolderIdentificationNumber;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignBankAccountNumber", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected Anstring34VItemType assetsOnBankStockAccountsForeignBankAccountNumber;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignBankName", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected Anstring70VItemType assetsOnBankStockAccountsForeignBankName;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected IsoCountryCodes3CharactersItemType assetsOnBankStockAccountsForeignCountryCode;
    @XmlElement(name = "AssetsOnBankStockAccountsForeignInterestTypeCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
