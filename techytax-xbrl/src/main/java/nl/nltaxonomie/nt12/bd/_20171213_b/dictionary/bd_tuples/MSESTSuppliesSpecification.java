...
import nl.nltaxonomie.nt12.bd._20171213_b.dictionary.bd_codes.VatRateTypeItemType;
import nl.nltaxonomie.nt12.bd._20171213_b.dictionary.bd_types.Monetary102ItemType;
import nl.nltaxonomie.nt12.bd._20171213_b.dictionary.bd_types.Perc32ItemType;
import nl.nltaxonomie.nt12.bd._20171213_b.dictionary.bd_types.VatNumberItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}MSCONCountryCode"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxableAmount"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}VATAmount"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}VATNumber"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}VATNumberCountryCode"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}VATRate"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}VATRateType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "MSCONCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data", required = true)
    protected IsoCountrycodeECMemberStatesItemType msconCountryCode;
    @XmlElement(name = "TaxableAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data", required = true)
    protected Monetary102ItemType taxableAmount;
    @XmlElement(name = "VATAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data", required = true)
    protected Monetary102ItemType vatAmount;
    @XmlElement(name = "VATNumber", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data", required = true)
    protected VatNumberItemType vatNumber;
    @XmlElement(name = "VATNumberCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data", required = true)
    protected IsoCountrycodeECMemberStatesItemType vatNumberCountryCode;
    @XmlElement(name = "VATRate", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data", required = true)
    protected Perc32ItemType vatRate;
    @XmlElement(name = "VATRateType", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data", required = true)
