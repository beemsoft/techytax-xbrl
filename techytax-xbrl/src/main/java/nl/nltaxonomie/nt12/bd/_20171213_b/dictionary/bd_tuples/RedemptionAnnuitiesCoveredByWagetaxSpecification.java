 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}RedemptionAnnuitiesCoveredByWagetaxAnnuityRedemption" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}RedemptionAnnuitiesCoveredByWagetaxPayingAgencyName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}RedemptionAnnuitiesCoveredByWagetaxWageLevy" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "RedemptionAnnuitiesCoveredByWagetaxAnnuityRedemption", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType redemptionAnnuitiesCoveredByWagetaxAnnuityRedemption;
    @XmlElement(name = "RedemptionAnnuitiesCoveredByWagetaxPayingAgencyName", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected Anstring70VItemType redemptionAnnuitiesCoveredByWagetaxPayingAgencyName;
    @XmlElement(name = "RedemptionAnnuitiesCoveredByWagetaxWageLevy", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
