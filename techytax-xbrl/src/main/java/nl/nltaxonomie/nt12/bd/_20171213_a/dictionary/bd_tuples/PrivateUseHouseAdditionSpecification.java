 ...
 *         &lt;/choice>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}PrivateUseHouseAdditionImmovablePropertyLawValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}PrivateUseHouseAdditionOwnHouseValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}PrivateUseHouseAdditionPeriodEnd" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}PrivateUseHouseAdditionPeriodStart" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}PrivateUseHouseAdditionRightsPercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}PrivateUseHouseAdditionWithdrawal" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PrivateUseHouseAdditionImmovablePropertyLawValue", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType privateUseHouseAdditionImmovablePropertyLawValue;
    @XmlElement(name = "PrivateUseHouseAdditionOwnHouseValue", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType privateUseHouseAdditionOwnHouseValue;
    @XmlElement(name = "PrivateUseHouseAdditionPeriodEnd", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected DateItemType privateUseHouseAdditionPeriodEnd;
    @XmlElement(name = "PrivateUseHouseAdditionPeriodStart", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected DateItemType privateUseHouseAdditionPeriodStart;
    @XmlElement(name = "PrivateUseHouseAdditionRightsPercentage", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected Perc32ItemType privateUseHouseAdditionRightsPercentage;
    @XmlElement(name = "PrivateUseHouseAdditionWithdrawal", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
