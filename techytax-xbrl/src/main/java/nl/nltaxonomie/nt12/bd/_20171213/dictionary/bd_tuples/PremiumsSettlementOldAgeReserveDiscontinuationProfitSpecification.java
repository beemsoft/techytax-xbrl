 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}PremiumsSettlementOldAgeReserveDiscontinuationProfitAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}PremiumsSettlementOldAgeReserveDiscontinuationProfitDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PremiumsSettlementOldAgeReserveDiscontinuationProfitAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType premiumsSettlementOldAgeReserveDiscontinuationProfitAmount;
    @XmlElement(name = "PremiumsSettlementOldAgeReserveDiscontinuationProfitDescription", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data")
