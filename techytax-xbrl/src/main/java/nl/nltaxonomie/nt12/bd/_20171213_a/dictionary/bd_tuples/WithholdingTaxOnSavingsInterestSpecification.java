...
import nl.nltaxonomie.nt12.bd._20171213_a.dictionary.bd_codes.IsoCountryCodeESRRItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}WithholdingTaxOnSavingsInterestAmount"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}WithholdingTaxOnSavingsInterestBankAccountNumber"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}WithholdingTaxOnSavingsInterestCountryCode"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "WithholdingTaxOnSavingsInterestAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data", required = true)
    protected NonNegativeMonetaryNoDecimalsItemType withholdingTaxOnSavingsInterestAmount;
    @XmlElement(name = "WithholdingTaxOnSavingsInterestBankAccountNumber", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data", required = true)
    protected Anstring34VItemType withholdingTaxOnSavingsInterestBankAccountNumber;
    @XmlElement(name = "WithholdingTaxOnSavingsInterestCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data", required = true)
