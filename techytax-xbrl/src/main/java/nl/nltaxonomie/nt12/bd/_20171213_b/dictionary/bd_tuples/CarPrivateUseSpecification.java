...
import nl.nltaxonomie.nt12.bd._20171213_b.dictionary.bd_types.Anstring6FItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}CarPrivateUseCalculated" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}CarPrivateUseCataloguePrice" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}CarPrivateUseExpensesChargesTaxpayersOwnExpense" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}CarPrivateUseKilometreRecordsExists" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}CarPrivateUsePeriodEndDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}CarPrivateUsePeriodStartDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}CarPrivateUseRegistration" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CarPrivateUseCalculated", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType carPrivateUseCalculated;
    @XmlElement(name = "CarPrivateUseCataloguePrice", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType carPrivateUseCataloguePrice;
    @XmlElement(name = "CarPrivateUseExpensesChargesTaxpayersOwnExpense", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType carPrivateUseExpensesChargesTaxpayersOwnExpense;
    @XmlElement(name = "CarPrivateUseKilometreRecordsExists", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected BooleanItemType carPrivateUseKilometreRecordsExists;
    @XmlElement(name = "CarPrivateUsePeriodEndDate", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected DateItemType carPrivateUsePeriodEndDate;
    @XmlElement(name = "CarPrivateUsePeriodStartDate", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected DateItemType carPrivateUsePeriodStartDate;
    @XmlElement(name = "CarPrivateUseRegistration", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
