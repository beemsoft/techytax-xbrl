...
import nl.nltaxonomie.nt12.bd._20171213_b.dictionary.bd_codes.TrainingItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}LoanFinalStudyYearPeriodEndDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}LoanFinalStudyYearPeriodForfaitAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}LoanFinalStudyYearPeriodStartDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}LoanFinalStudyYearPeriodTrainingType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "LoanFinalStudyYearPeriodEndDate", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected DateItemType loanFinalStudyYearPeriodEndDate;
    @XmlElement(name = "LoanFinalStudyYearPeriodForfaitAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType loanFinalStudyYearPeriodForfaitAmount;
    @XmlElement(name = "LoanFinalStudyYearPeriodStartDate", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected DateItemType loanFinalStudyYearPeriodStartDate;
    @XmlElement(name = "LoanFinalStudyYearPeriodTrainingType", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
