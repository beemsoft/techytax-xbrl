...
import nl.nltaxonomie.nt12.bd._20171213.dictionary.bd_types.VatNumberItemType;
 ...
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}VATNumber"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}VATNumberCountryCode"/>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "VATNumber", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data", required = true)
    protected VatNumberItemType vatNumber;
    @XmlElement(name = "VATNumberCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data", required = true)
