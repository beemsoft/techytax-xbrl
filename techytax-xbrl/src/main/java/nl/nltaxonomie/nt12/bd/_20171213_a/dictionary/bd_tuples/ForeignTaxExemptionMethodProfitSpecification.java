...
import nl.nltaxonomie.nt12.bd._20171213_a.dictionary.bd_types.Anstring11VItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ExchangeRateExemptionMethod" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ExemptionMethodCountry" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ExemptionMethodForwardedProfitOrLossToOvertake" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ExemptionMethodProfitComponent" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ExemptionMethodProfitNationalCurrency" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ProfitEuroExemptionMethod" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ExchangeRateExemptionMethod", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected Anstring11VItemType exchangeRateExemptionMethod;
    @XmlElement(name = "ExemptionMethodCountry", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected IsoCountryCodes3CharactersItemType exemptionMethodCountry;
    @XmlElement(name = "ExemptionMethodForwardedProfitOrLossToOvertake", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType exemptionMethodForwardedProfitOrLossToOvertake;
    @XmlElement(name = "ExemptionMethodProfitComponent", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected Anstring70VItemType exemptionMethodProfitComponent;
    @XmlElement(name = "ExemptionMethodProfitNationalCurrency", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType exemptionMethodProfitNationalCurrency;
    @XmlElement(name = "ProfitEuroExemptionMethod", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
