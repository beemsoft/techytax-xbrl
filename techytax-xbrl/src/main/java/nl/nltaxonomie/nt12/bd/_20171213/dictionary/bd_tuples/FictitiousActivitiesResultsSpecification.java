 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}FictitiousActivitiesResultAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data}FictitiousActivitiesResultDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "FictitiousActivitiesResultAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType fictitiousActivitiesResultAmount;
    @XmlElement(name = "FictitiousActivitiesResultDescription", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213/dictionary/bd-data")
