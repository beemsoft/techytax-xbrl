 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}OwnHouseGroundLeaseBuildingPeriodicPaymentsAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}OwnHouseGroundLeaseBuildingPeriodicPaymentsDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "OwnHouseGroundLeaseBuildingPeriodicPaymentsAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType ownHouseGroundLeaseBuildingPeriodicPaymentsAmount;
    @XmlElement(name = "OwnHouseGroundLeaseBuildingPeriodicPaymentsDescription", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
