 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}AssetBankAccountSavingsAccountnumberBox3" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}AssetBankAccountSavingsCertificateEtcCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}AssetBankAccountSavingsCertificateEtcCreditUndivided" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}AssetBankAccountSavingsCertificateEtcDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}AssetBankAccountSavingsCertificateEtcValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}AssetBankAccountSavingsProductID" minOccurs="0"/>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "AssetBankAccountSavingsAccountnumberBox3", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected Anstring34VItemType assetBankAccountSavingsAccountnumberBox3;
    @XmlElement(name = "AssetBankAccountSavingsCertificateEtcCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected IsoCountryCodes3CharactersItemType assetBankAccountSavingsCertificateEtcCountryCode;
    @XmlElement(name = "AssetBankAccountSavingsCertificateEtcCreditUndivided", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType assetBankAccountSavingsCertificateEtcCreditUndivided;
    @XmlElement(name = "AssetBankAccountSavingsCertificateEtcDescription", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected Anstring70VItemType assetBankAccountSavingsCertificateEtcDescription;
    @XmlElement(name = "AssetBankAccountSavingsCertificateEtcValue", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType assetBankAccountSavingsCertificateEtcValue;
    @XmlElement(name = "AssetBankAccountSavingsProductID", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
