...
import nl.nltaxonomie.nt12.bd._20171213_b.dictionary.bd_types.Anstring30VItemType;
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}DeclarationsDeliveryPeriodicCumulativeNumberOfItems" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}DeclarationsDeliveryPeriodicCumulativePercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}DeclarationsDeliveryPeriodicName" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "DeclarationsDeliveryPeriodicCumulativeNumberOfItems", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected NonNegativeInteger5VItemType declarationsDeliveryPeriodicCumulativeNumberOfItems;
    @XmlElement(name = "DeclarationsDeliveryPeriodicCumulativePercentage", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected Perc32ItemType declarationsDeliveryPeriodicCumulativePercentage;
    @XmlElement(name = "DeclarationsDeliveryPeriodicName", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
