 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox1IncomeWageAndPensionCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox1IncomeWageAndPensionDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox1IncomeWageAndPensionIncomeAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data}TaxationElsewhereBox1IncomeWageAndPensionTaxAmount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "TaxationElsewhereBox1IncomeWageAndPensionCountryCode", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected IsoCountryCodes3CharactersItemType taxationElsewhereBox1IncomeWageAndPensionCountryCode;
    @XmlElement(name = "TaxationElsewhereBox1IncomeWageAndPensionDescription", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected Anstring70VItemType taxationElsewhereBox1IncomeWageAndPensionDescription;
    @XmlElement(name = "TaxationElsewhereBox1IncomeWageAndPensionIncomeAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType taxationElsewhereBox1IncomeWageAndPensionIncomeAmount;
    @XmlElement(name = "TaxationElsewhereBox1IncomeWageAndPensionTaxAmount", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.b/dictionary/bd-data")
