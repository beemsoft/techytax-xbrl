 ...
 *         &lt;/choice>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ImmovablePropertyProfitsAndLossesWithdrawal" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ImmovablePropertyWithdrawalBookValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ImmovablePropertyWithdrawalEstimationValuer" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ImmovablePropertyWithdrawalValueOfTrade" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ImmovablePropertyWithdrawalValuerName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data}ImmovablePropertyWithdrawelTransferToThird" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ImmovablePropertyProfitsAndLossesWithdrawal", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected MonetaryNoDecimalsItemType immovablePropertyProfitsAndLossesWithdrawal;
    @XmlElement(name = "ImmovablePropertyWithdrawalBookValue", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType immovablePropertyWithdrawalBookValue;
    @XmlElement(name = "ImmovablePropertyWithdrawalEstimationValuer", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected BooleanItemType immovablePropertyWithdrawalEstimationValuer;
    @XmlElement(name = "ImmovablePropertyWithdrawalValueOfTrade", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected NonNegativeMonetaryNoDecimalsItemType immovablePropertyWithdrawalValueOfTrade;
    @XmlElement(name = "ImmovablePropertyWithdrawalValuerName", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
    protected Anstring70VItemType immovablePropertyWithdrawalValuerName;
    @XmlElement(name = "ImmovablePropertyWithdrawelTransferToThird", namespace = "http://www.nltaxonomie.nl/nt12/bd/20171213.a/dictionary/bd-data")
