 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereBox3SetoffAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereBox3SetoffCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereBox3SetoffDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}TaxationElsewhereBox3SetoffTaxAmount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "TaxationElsewhereBox3SetoffAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType taxationElsewhereBox3SetoffAmount;
    @XmlElement(name = "TaxationElsewhereBox3SetoffCountryCode", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected IsoCountryCodes3CharactersItemType taxationElsewhereBox3SetoffCountryCode;
    @XmlElement(name = "TaxationElsewhereBox3SetoffDescription", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected Anstring35VItemType taxationElsewhereBox3SetoffDescription;
    @XmlElement(name = "TaxationElsewhereBox3SetoffTaxAmount", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
