 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}AlimonyAmountDeductibleCosts" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}AlimonyDescriptionDeductibleCosts" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "AlimonyAmountDeductibleCosts", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected MonetaryNoDecimalsItemType alimonyAmountDeductibleCosts;
    @XmlElement(name = "AlimonyDescriptionDeductibleCosts", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
