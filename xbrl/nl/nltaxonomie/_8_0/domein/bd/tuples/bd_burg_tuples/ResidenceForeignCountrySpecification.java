 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}CountryResidenceEndDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}CountryResidenceStartDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers}ResidenceForeignCountryCountryCodeISO" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CountryResidenceEndDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected DateItemType countryResidenceEndDate;
    @XmlElement(name = "CountryResidenceStartDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
    protected DateItemType countryResidenceStartDate;
    @XmlElement(name = "ResidenceForeignCountryCountryCodeISO", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-burgers")
