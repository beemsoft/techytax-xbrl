 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUseCalculated" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUseCataloguePrice" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUseExpensesChargesTaxpayersOwnExpense" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUseKilometreRecordsExists" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUsePeriodEndDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUsePeriodStartDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}CarPrivateUseRegistration" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CarPrivateUseCalculated", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType carPrivateUseCalculated;
    @XmlElement(name = "CarPrivateUseCataloguePrice", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType carPrivateUseCataloguePrice;
    @XmlElement(name = "CarPrivateUseExpensesChargesTaxpayersOwnExpense", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType carPrivateUseExpensesChargesTaxpayersOwnExpense;
    @XmlElement(name = "CarPrivateUseKilometreRecordsExists", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected BooleanItemType carPrivateUseKilometreRecordsExists;
    @XmlElement(name = "CarPrivateUsePeriodEndDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected DateItemType carPrivateUsePeriodEndDate;
    @XmlElement(name = "CarPrivateUsePeriodStartDate", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected DateItemType carPrivateUsePeriodStartDate;
    @XmlElement(name = "CarPrivateUseRegistration", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
