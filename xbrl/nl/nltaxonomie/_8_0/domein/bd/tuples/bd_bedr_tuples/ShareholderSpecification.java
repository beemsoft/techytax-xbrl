 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderAddressHouseNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderAddressHouseNumberAddition" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderAddressPlaceOfResidence" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderAddressStreetName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderDebtToEntity" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderDirectorLargeShareholderIdentificationNumber" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderInterestPaid" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderInterestReceived" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderIssuedCapitalPercentage" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderName" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderOrdinarySharesNominalValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderPrefenceSharesNominalValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderPrioritySharesNominalValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven}ShareholderReceivablesOnEntity" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "ShareholderAddressHouseNumber", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring5VItemType shareholderAddressHouseNumber;
    @XmlElement(name = "ShareholderAddressHouseNumberAddition", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring4VItemType shareholderAddressHouseNumberAddition;
    @XmlElement(name = "ShareholderAddressPlaceOfResidence", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring24VItemType shareholderAddressPlaceOfResidence;
    @XmlElement(name = "ShareholderAddressStreetName", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring24VItemType shareholderAddressStreetName;
    @XmlElement(name = "ShareholderCountryCode", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected IsoCountryCodes3CharactersItemType shareholderCountryCode;
    @XmlElement(name = "ShareholderDebtToEntity", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType shareholderDebtToEntity;
    @XmlElement(name = "ShareholderDirectorLargeShareholderIdentificationNumber", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Test11ItemType shareholderDirectorLargeShareholderIdentificationNumber;
    @XmlElement(name = "ShareholderInterestPaid", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected NonNegativeMonetaryNoDecimalsItemType shareholderInterestPaid;
    @XmlElement(name = "ShareholderInterestReceived", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected NonNegativeMonetaryNoDecimalsItemType shareholderInterestReceived;
    @XmlElement(name = "ShareholderIssuedCapitalPercentage", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Pure52ItemType shareholderIssuedCapitalPercentage;
    @XmlElement(name = "ShareholderName", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType shareholderName;
    @XmlElement(name = "ShareholderOrdinarySharesNominalValue", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType shareholderOrdinarySharesNominalValue;
    @XmlElement(name = "ShareholderPrefenceSharesNominalValue", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType shareholderPrefenceSharesNominalValue;
    @XmlElement(name = "ShareholderPrioritySharesNominalValue", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType shareholderPrioritySharesNominalValue;
    @XmlElement(name = "ShareholderReceivablesOnEntity", namespace = "http://www.nltaxonomie.nl/8.0/basis/bd/items/bd-bedrijven")
     ...
     *     
     */
    public Anstring5VItemType getShareholderAddressHouseNumber() {
     ...
     *     
     */
    public void setShareholderAddressHouseNumber(Anstring5VItemType value) {
