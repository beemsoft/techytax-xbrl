 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateWithdrawalOtherAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}PrivateWithdrawalOtherDescription" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "PrivateWithdrawalOtherAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType privateWithdrawalOtherAmount;
    @XmlElement(name = "PrivateWithdrawalOtherDescription", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
