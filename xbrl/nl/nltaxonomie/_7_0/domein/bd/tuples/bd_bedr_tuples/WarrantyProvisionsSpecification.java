 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}WarrantyProvisionAllocationAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}WarrantyProvisionDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}WarrantyProvisionFiscalAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven}WarrantyProvisionWithdrawalAmount" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "WarrantyProvisionAllocationAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType warrantyProvisionAllocationAmount;
    @XmlElement(name = "WarrantyProvisionDescription", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected Anstring70VItemType warrantyProvisionDescription;
    @XmlElement(name = "WarrantyProvisionFiscalAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
    protected MonetaryNoDecimalsItemType warrantyProvisionFiscalAmount;
    @XmlElement(name = "WarrantyProvisionWithdrawalAmount", namespace = "http://www.nltaxonomie.nl/7.0/basis/bd/items/bd-bedrijven")
