 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen}HouseNumberAddition" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen}HouseNumberNL" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen}PlaceOfResidenceNL" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0/basis/sbr/items/nl-common-data}PostalCodeNL" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen}StreetNameNL" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AddressDutchSpecification
    extends Placeholder
{

    @XmlElement(name = "HouseNumberAddition", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen")
    protected Anstring4VItemType houseNumberAddition;
    @XmlElement(name = "HouseNumberNL", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen")
    protected NonNegativeInteger5VItemType houseNumberNL;
    @XmlElement(name = "PlaceOfResidenceNL", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen")
    ...
    @XmlElement(name = "StreetNameNL", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-algemeen")
