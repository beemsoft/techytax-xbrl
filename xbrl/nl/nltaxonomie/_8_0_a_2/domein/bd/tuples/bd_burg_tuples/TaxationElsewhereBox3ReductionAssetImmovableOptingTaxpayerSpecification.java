 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerCountryCode" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerDebt" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerDescription" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerValue" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}TaxationElsewhereBox3ReductionAssetsImmovablePropertyOptingTaxpayer" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerCountryCode", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected IsoCountryCodes3CharactersItemType taxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerCountryCode;
    @XmlElement(name = "TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerDebt", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType taxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerDebt;
    @XmlElement(name = "TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerDescription", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected Anstring35VItemType taxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerDescription;
    @XmlElement(name = "TaxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerValue", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType taxationElsewhereBox3ReductionAssetImmovableOptingTaxpayerValue;
    @XmlElement(name = "TaxationElsewhereBox3ReductionAssetsImmovablePropertyOptingTaxpayer", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
