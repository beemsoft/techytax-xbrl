 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}CommutingExpensesDaysPerWeekCount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}CommutingExpensesDistance" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}CommutingExpensesLocationOfActivities" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}CommutingExpensesTaxDeductionByPeriodAmount" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}CommutingExpensesTaxDeductionPeriodEnd" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}CommutingExpensesTaxDeductionPeriodStart" minOccurs="0"/>
 *         &lt;element ref="{http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers}CountDaysCommutedMoreThanNinetyKilometresSingleTrip" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Placeholder
{
    ...
    @XmlElement(name = "CommutingExpensesDaysPerWeekCount", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected NonNegativeInteger1ItemType commutingExpensesDaysPerWeekCount;
    @XmlElement(name = "CommutingExpensesDistance", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected NonNegativeInteger3VItemType commutingExpensesDistance;
    @XmlElement(name = "CommutingExpensesLocationOfActivities", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected Anstring35VItemType commutingExpensesLocationOfActivities;
    @XmlElement(name = "CommutingExpensesTaxDeductionByPeriodAmount", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected NonNegativeMonetaryNoDecimalsItemType commutingExpensesTaxDeductionByPeriodAmount;
    @XmlElement(name = "CommutingExpensesTaxDeductionPeriodEnd", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected DateItemType commutingExpensesTaxDeductionPeriodEnd;
    @XmlElement(name = "CommutingExpensesTaxDeductionPeriodStart", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
    protected DateItemType commutingExpensesTaxDeductionPeriodStart;
    @XmlElement(name = "CountDaysCommutedMoreThanNinetyKilometresSingleTrip", namespace = "http://www.nltaxonomie.nl/8.0.a.2/basis/bd/items/bd-burgers")
