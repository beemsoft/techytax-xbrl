 ...
 */
public class GetStatussenProcesRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument
{
    
    public GetStatussenProcesRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETSTATUSSENPROCESREQUEST$0 = 
        new javax.xml.namespace.QName("http://logius.nl/digipoort/koppelvlakservices/1.2/", "getStatussenProcesRequest");
    
    
    /**
     * Gets the "getStatussenProcesRequest" element
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument.GetStatussenProcesRequest getGetStatussenProcesRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument.GetStatussenProcesRequest target = null;
            target = (nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument.GetStatussenProcesRequest)get_store().find_element_user(GETSTATUSSENPROCESREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetStatussenProcesRequest(nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument.GetStatussenProcesRequest getStatussenProcesRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument.GetStatussenProcesRequest)get_store().add_element_user(GETSTATUSSENPROCESREQUEST$0);
            }
            target.set(getStatussenProcesRequest);
        }
    }
     ...
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument.GetStatussenProcesRequest addNewGetStatussenProcesRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetStatussenProcesRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetStatussenProcesRequestDocument.GetStatussenProcesRequest
    {
        
        public GetStatussenProcesRequestImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
