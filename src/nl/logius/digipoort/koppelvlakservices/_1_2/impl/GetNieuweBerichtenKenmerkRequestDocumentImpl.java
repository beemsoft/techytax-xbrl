 ...
 */
public class GetNieuweBerichtenKenmerkRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument
{
    
    public GetNieuweBerichtenKenmerkRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETNIEUWEBERICHTENKENMERKREQUEST$0 = 
        new javax.xml.namespace.QName("http://logius.nl/digipoort/koppelvlakservices/1.2/", "getNieuweBerichtenKenmerkRequest");
    
    
    /**
     * Gets the "getNieuweBerichtenKenmerkRequest" element
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument.GetNieuweBerichtenKenmerkRequest getGetNieuweBerichtenKenmerkRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument.GetNieuweBerichtenKenmerkRequest target = null;
            target = (nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument.GetNieuweBerichtenKenmerkRequest)get_store().find_element_user(GETNIEUWEBERICHTENKENMERKREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetNieuweBerichtenKenmerkRequest(nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument.GetNieuweBerichtenKenmerkRequest getNieuweBerichtenKenmerkRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument.GetNieuweBerichtenKenmerkRequest)get_store().add_element_user(GETNIEUWEBERICHTENKENMERKREQUEST$0);
            }
            target.set(getNieuweBerichtenKenmerkRequest);
        }
    }
     ...
     */
    public nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument.GetNieuweBerichtenKenmerkRequest addNewGetNieuweBerichtenKenmerkRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetNieuweBerichtenKenmerkRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nl.logius.digipoort.koppelvlakservices._1_2.GetNieuweBerichtenKenmerkRequestDocument.GetNieuweBerichtenKenmerkRequest
    {
        
        public GetNieuweBerichtenKenmerkRequestImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
