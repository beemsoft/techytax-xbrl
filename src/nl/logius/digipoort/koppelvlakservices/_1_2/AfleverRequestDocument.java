 ...
 * afleverRequest(@http://logius.nl/digipoort/koppelvlakservices/1.2/) element.
 * 
 * This is a complex type.
 */
public interface AfleverRequestDocument extends org.apache.xmlbeans.XmlObject {
	public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType) org.apache.xmlbeans.XmlBeans
			.typeSystemForClassLoader(
					AfleverRequestDocument.class.getClassLoader(),
					"schemaorg_apache_xmlbeans.system.s3A1280A6A40D92135322981C920AADDA")
			.resolveHandle("afleverrequest7fe1doctype");

	/**
	 * Gets the "afleverRequest" element
	 */
	nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument.AfleverRequest getAfleverRequest();

	/**
	 * Sets the "afleverRequest" element
	 */
	void setAfleverRequest(
			nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument.AfleverRequest afleverRequest);

	/**
	 * Appends and returns a new empty "afleverRequest" element
	 */
	nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument.AfleverRequest addNewAfleverRequest();

	/**
	 * An XML
	 * afleverRequest(@http://logius.nl/digipoort/koppelvlakservices/1.2/).
	 * 
	 * This is a complex type.
	 */
	public interface AfleverRequest extends org.apache.xmlbeans.XmlObject {
		public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType) org.apache.xmlbeans.XmlBeans
				.typeSystemForClassLoader(
						AfleverRequest.class.getClassLoader(),
						"schemaorg_apache_xmlbeans.system.s3A1280A6A40D92135322981C920AADDA")
				.resolveHandle("afleverrequest47c7elemtype");
		 ...
		 */
		void xsetKenmerk(
				nl.logius.digipoort.koppelvlakservices._1_2.KenmerkType kenmerk);
		 ...
		 */
		void xsetBerichtsoort(
				nl.logius.digipoort.koppelvlakservices._1_2.BerichtsoortType berichtsoort);
		 ...
		 */
		void xsetBerichtkenmerk(
				nl.logius.digipoort.koppelvlakservices._1_2.BerichtkenmerkType berichtkenmerk);
		 ...
		 */
		void xsetAanleverkenmerk(
				nl.logius.digipoort.koppelvlakservices._1_2.AanleverkenmerkType aanleverkenmerk);
		 ...
		 */
		void xsetTijdstempelAangeleverd(
				org.apache.xmlbeans.XmlDateTime tijdstempelAangeleverd);
		 ...
		 */
		void setIdentiteitBelanghebbende(
				nl.logius.digipoort.koppelvlakservices._1_2.IdentiteitType identiteitBelanghebbende);
		 ...
		 */
		void xsetRolBelanghebbende(
				nl.logius.digipoort.koppelvlakservices._1_2.RolType rolBelanghebbende);
		 ...
		 */
		void xsetIdentiteitAanleveraar(
				nl.logius.digipoort.koppelvlakservices._1_2.IdentiteitsnummerType identiteitAanleveraar);
		 ...
		 */
		void setIdentiteitOntvanger(
				nl.logius.digipoort.koppelvlakservices._1_2.IdentiteitType identiteitOntvanger);
		 ...
		 */
		void xsetRolOntvanger(
				nl.logius.digipoort.koppelvlakservices._1_2.RolType rolOntvanger);
		 ...
		 */
		void setBerichtInhoud(
				nl.logius.digipoort.koppelvlakservices._1_2.BerichtInhoudType berichtInhoud);
		 ...
		 */
		void setBerichtBijlagen(
				nl.logius.digipoort.koppelvlakservices._1_2.BerichtBijlagenType berichtBijlagen);
		 ...
		 */
		void setConstateringenLijst(
				nl.logius.digipoort.koppelvlakservices._1_2.ConstateringenLijstType constateringenLijst);
		 ...
		 */
		void setAdditioneleElementenLijst(
				nl.logius.digipoort.koppelvlakservices._1_2.AdditioneleElementenLijstType additioneleElementenLijst);
		...
		public static final class Factory {
			public static nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument.AfleverRequest newInstance() {
				return (nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument.AfleverRequest) org.apache.xmlbeans.XmlBeans
	...
	public static final class Factory {
		public static nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument newInstance() {
			return (nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument) org.apache.xmlbeans.XmlBeans
					.getContextTypeLoader().newInstance(type, null);
		}
		 ...
		 */
		public static nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument parse(
		 ...
		 */
		public static nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument parse(
				java.io.File file) throws org.apache.xmlbeans.XmlException,
				java.io.IOException {
			return (nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument) org.apache.xmlbeans.XmlBeans
		...
		public static nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument parse(
				java.net.URL u) throws org.apache.xmlbeans.XmlException,
				java.io.IOException {
			return (nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument) org.apache.xmlbeans.XmlBeans
		...
		public static nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument parse(
				java.io.Reader r) throws org.apache.xmlbeans.XmlException,
				java.io.IOException {
			return (nl.logius.digipoort.koppelvlakservices._1_2.AfleverRequestDocument) org.apache.xmlbeans.XmlBeans
